 ...
 * @author jange
 */
@WebServlet(urlPatterns = {"/RevisionOngServlet"})
public class RevisionOngServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Notificacion se = notificacionFacade.find(notificacion);

        if (boton.equals("Aceptar solicitante")) {
            List<Usuario> lista = act.getUsuarioList();
            lista.add(solicitante);
            act.setUsuarioList(lista);
            actividadFacade.edit(act);
            sesion.setAttribute("mensaje", "Se enviará notificacion al solicitante de aceptacion");
