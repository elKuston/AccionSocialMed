 ...
 * @author romol
 */
@WebServlet(urlPatterns = {"/DarDeBajaServlet"})
public class DarDeBajaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Ong b = ongFacade.find(request.getParameter("bajar"));
        b.setClaveRegistro(""+b.getCorreo().hashCode());
        b.setActiva(Boolean.FALSE);
        ongFacade.edit(b);
