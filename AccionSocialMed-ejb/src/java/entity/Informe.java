...
@NamedQueries({
    ...
    , @NamedQuery(name = "Informe.findByNotaparticipante", query = "SELECT i FROM Informe i WHERE i.notaparticipante = :notaparticipante")
    ...
    , @NamedQuery(name = "Informe.findByFechaopinion", query = "SELECT i FROM Informe i WHERE i.fechaopinion = :fechaopinion")
...
public class Informe implements Serializable {
    ...
    @Column(name = "NOTAPARTICIPANTE")
    private Integer notaparticipante;
    @Size(max = 5000)
    ...
    public Integer getNotaparticipante() {
        return notaparticipante;
    }

    public void setNotaparticipante(Integer notaparticipante) {
        this.notaparticipante = notaparticipante;
    }
